...
const DashboardLayout = ({ children, title, role: explicitRole, customSidebar }) => {
  ...
  const user = localUser || auth.user;
  const role = explicitRole || user?.role || "USER";
  const basePath = role === "PETERNAK" ? "/peternak" : role === "RPH" ? "/rph" : role === "PASAR_HEWAN" ? "/pasarhewan" : `/${(role || "").toLowerCase()}`;
  ...
  const activeSectionName = (() => {
    ...
    // Role-specific
    if (role === "PASAR_HEWAN") {
      if (path.startsWith("/ternak")) return "Data Sapi";
      if (path.startsWith("/transfer")) return "Transaksi";
      if (path.startsWith("/health")) return "Cek Kesehatan";
              ...
              <ul className="space-y-2 flex-1 overflow-y-auto">
                <li>
                  <Link
                    ...
                    className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive(`${basePath}/dashboard`) ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                  >
                ...
                {role === "PETERNAK" && (
                  <>
                    <li>
                      <Link
                        to="/peternak/sapi"
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/peternak/sapi") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                          isActive("/peternak/daftar-ternak") ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                        }`}
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/peternak/kesehatan") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                ...
                {role === "RPH" && (
                  <>
                    <li>
                      <Link
                        to="/rph/penyembelihan"
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/rph/penyembelihan") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                    ...
                    <li>
                      <Link
                        to="/rph/daging"
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/rph/daging") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                  ...
                  <>
                    <li>
                      <Link
                        ...
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/pasarhewan/ternak") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                        <i className="fas fa-cow mr-3"></i>
                        <span>Data Sapi</span>
                      </Link>
                    ...
                    <li>
                      <Link
                        ...
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                          isActive("/pasarhewan/transfer") ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                        }`}
                      >
                        <i className="fas fa-exchange-alt mr-3"></i>
                        <span>Transaksi</span>
                    ...
                    <li>
                      <Link
                        ...
                        className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${isActive("/pasarhewan/health") ? "bg-primary/10 text-primary border-primary" : "border-transparent"}`}
                      >
                        <i className="fas fa-stethoscope mr-3"></i>
                    ...
                    <>
                      <li>
                        <Link
                          ...
                          className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                            isActive("/pasarhewan/profile") ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                          }`}
                        >
                      ...
                      <li>
                        <Link
                          ...
                          className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                            isActive("/pasarhewan/settings") ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                          }`}
                        >
                    ...
                    <>
                      <li>
                        <Link
                          ...
                          className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                            isActive(`/${role.toLowerCase()}/profil`) ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                          }`}
                        >
                          <i className="fas fa-user mr-3"></i>
                          <span>Profil</span>
                      ...
                      <li>
                        <Link
                          to={`/${role.toLowerCase()}/pengaturan`}
                          className={`flex items-center p-2 rounded-lg text-gray-800 hover:bg-primaryLight hover:text-primary border-r-4 ${
                            isActive(`/${role.toLowerCase()}/pengaturan`) ? "bg-primary/10 text-primary border-primary" : "border-transparent"
                          }`}
                        >
                          <i className="fas fa-cog mr-3"></i>
                          <span>Pengaturan</span>
            ...
            <div className="grid grid-cols-3 items-center bg-white border border-gray-200 rounded-lg px-4 py-3 mb-4 shadow-sm">
              ...
              <div className="flex items-center gap-3 justify-self-end">
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-800">{user ? user.entityData.nama || user.email || "User" : "User"}</div>
                  {user && user.role && <div className="text-xs text-gray-500">{roleNiceLabel(user.role)}</div>}
                </div>
                <div className="w-9 h-9 bg-gradient-to-r from-primary to-blue-500 rounded-full flex items-center justify-center text-white shadow">
                  {user && (user.username || user.email) ? (user.username || user.email).charAt(0).toUpperCase() : "U"}
                </div>
              </div>
            </div>
          }
