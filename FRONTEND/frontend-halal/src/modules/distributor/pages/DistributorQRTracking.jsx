    ...
    try {
      ...
      if (response.ok) {
        ...
        const filtered = allDaging.filter(
          (d) => d.currentOwnerType === "DISTRIBUTOR" && d.currentOwnerId === userData.id
        );
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          ...
          {loading ? (
            ...
            <p className="text-sm text-gray-500 text-center py-8">Anda belum memiliki daging</p>
          ) : (
        ...
        {selectedDaging && <QRTracking type="daging" data={selectedDaging} role="distributor" />}
      </div>
    </DashboardLayout>
  );
};

export default DistributorQRTracking;
