...
const RphTracking = () => {
  ...
  useEffect(() => {
    // Load data sapi di RPH
    const sapiData = JSON.parse(localStorage.getItem("rphSapi") || "[]");
    setMySapi(sapiData);

    // Load data daging hasil sembelihan
    const dagingData = JSON.parse(localStorage.getItem("rphDagingLocal") || "[]");
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow p-6 mt-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">
                {activeTab === "sapi" ? "Sapi di RPH" : "Daging Hasil Sembelihan"}
              </h3>
                ...
                {activeTab === "sapi" && mySapi.length > 0 ? (
                  ...
                  myDaging.map((item) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500">Dari Sapi: {item.sapiId.substring(0, 12)}...</p>
                    </button>
                  ))
                ) : (
