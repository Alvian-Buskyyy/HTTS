...
// Transaksi Daging: gunakan data daging lokal dari konversi operasi (rphDagingLocal)
const RphTransaksiDaging = () => {
  ...
  return (
    <DashboardLayout title="Transaksi Daging" role="RPH" customSidebar={<RphSidebar /> }>
...
export default RphTransaksiDaging;
