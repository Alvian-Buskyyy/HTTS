...
const PasarHewanTernak = () => {
  ...
  // Keep existing data fields and seed data
  const [cattleData, setCattleData] = useState([
    { id: 'HT-2023-0054', type: 'Sapi Betina', source: 'Peternakan Ahmad', arrivalDate: '16 Jul 2025', weight: 325, healthStatus: 'Terverifikasi' },
    { id: 'HT-2023-0053', type: 'Sapi Jantan', source: 'Peternakan Salam', arrivalDate: '16 Jul 2025', weight: 410, healthStatus: 'Terverifikasi' },
    { id: 'HT-2023-0051', type: 'Sapi Betina', source: 'Peternakan Ahmad', arrivalDate: '15 Jul 2025', weight: 315, healthStatus: 'Menunggu' },
    { id: 'HT-2023-0050', type: 'Sapi Jantan', source: 'Peternakan Wijaya', arrivalDate: '14 Jul 2025', weight: 390, healthStatus: 'Terverifikasi' },
    { id: 'HT-2023-0049', type: 'Sapi Betina', source: 'Peternakan Ahmad', arrivalDate: '14 Jul 2025', weight: 330, healthStatus: 'Terverifikasi' },
    { id: 'HT-2023-0048', type: 'Sapi Jantan', source: 'Peternakan Salam', arrivalDate: '13 Jul 2025', weight: 405, healthStatus: 'Terverifikasi' }
  ]);
