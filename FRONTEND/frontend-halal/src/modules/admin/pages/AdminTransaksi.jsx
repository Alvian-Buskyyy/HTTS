...
const AdminTransaksi = () => {
  ...
  return (
    <DashboardLayout title="Data Transaksi" role="ADMIN" customSidebar={<AdminSidebar /> }>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                {f1.length===0 && <tr><td className="px-4 py-4 text-gray-500" colSpan={5}>Tidak ada data</td></tr>}
              </tbody>
            </table>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                {f2.length===0 && <tr><td className="px-4 py-4 text-gray-500" colSpan={6}>Tidak ada data</td></tr>}
              </tbody>
            </table>
          </div>
        )}
